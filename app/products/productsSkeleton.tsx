...
export default function ProductsSkeleton() {
  return (
    <div className="flex flex-col justify-center items-center">
      <Card className="w-100 h-100 m-4 p-4">
        <CardHeader>
          <CardTitle></CardTitle>
          <div className="flex items-center gap-5 self-start rounded-lg bg-slate-400 px-6 py-3 text-sm md:text-base">
            <div className="relative h-full object-cover">
              <div className="w-16 h-8 rounded-md bg-gray-200" />
            </div>
          </div>

          <CardDescription>
            <Badge className="w-16 h-8 bg-slate-200"></Badge>
            <div className="w-16 h-8 bg-slate-200"></div>
            <div className="w-16 h-8 bg-slate-200"></div>
          </CardDescription>
        </CardHeader>
        <CardContent>
        ...
        <CardFooter>
          ...
          <div className="card-actions justify-end">
            <div className="w-16 h-8 bg-slate-200 font-semibold py-2 px-4 border border-gray-200 rounded"></div>
          </div>
        </CardFooter>
      </Card>
    </div>
