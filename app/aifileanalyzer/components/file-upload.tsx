...
import { cn } from "../lib/utils";
import { AlertCircle, FileIcon, Loader2, UploadCloud, X } from "lucide-react";
    ...
    <div className="grid grid-cols-1 gap-4 md:grid-cols-2 w-full">
      <div className="text-xl">
        <Textarea
          ...
          className={cn("text-xl mb-4", className)}
        />
      ...
      <div className="flex flex-col items-center gap-4 border rounded-md p-8">
        <div className="text-xl border rounded-md p-2">aiResult:</div>
        <div className="text-xl">{aiResult}</div>
