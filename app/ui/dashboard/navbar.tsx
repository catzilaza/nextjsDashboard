...
const Navbar = async () => {
  const mysession: any = await getLoginSession();
  return (
...
{
  /* <div className="flex h-20 flex-row justify-end px-3 py-1 md:px-2">
<div className="flex space-x-2">
  ...
  <button
    type="button"
    className="flex h-[48px] w-auto grow items-center justify-center gap-2 rounded-md p-3 text-sm font-medium hover:bg-sky-100 hover:text-blue-600 md:flex-none md:justify-start md:p-2 md:px-3"
  >
