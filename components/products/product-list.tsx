...
//         <Link
//           href={`/products/${product.dessert_id}/detail`}
//           className="flex items-center gap-5 self-start rounded-lg bg-white px-6 py-3 text-sm font-medium text-white transition-colors hover:bg-blue-200 md:text-base"
//         >
//           <div className="relative overflow-hidden border-2 border-gray-300 h-32 w-32 md:h-32 md:w-32 lg:h-64 lg:w-64 ">
//             <img
//               className="object-cover w-full h-full transition-transform duration-300 hover:scale-105"
